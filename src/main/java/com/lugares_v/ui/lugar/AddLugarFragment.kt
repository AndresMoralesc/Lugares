...
imagenUtiles= ImagenUtiles(
    ...
    private fun subeAudio(){
        ...
        if (audioFile.exists()&& audioFile.isFile && audioFile.canRead()) {
            ...
            val rutaNube= "lugaresAppp/${Firebase.auth.currentUser?.email}/audios/${audioFile.name}"
    ...
    private fun subeImgen(rutaPublicaAudio: String){
        ...
        if (imagenFile.exists()&& imagenFile.isFile && imagenFile.canRead()) {
            ...
            val rutaNube= "lugaresAppp/${Firebase.auth.currentUser?.email}/imagenes/${imagenFile.name}"
            ...
            referencia.putFile(rutaLocal)
                .addOnSuccessListener {
                    ...
                    referencia.downloadUrl.addOnSuccessListener{
                        ...
                        subeImgen(rutaPublicaAudio,rutaPublicaImagen)
                    }
                }
                .addOnFailureListener{
