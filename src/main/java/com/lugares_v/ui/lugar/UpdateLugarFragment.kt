...
class UpdateLugarFragment : Fragment() {
    ...
    private fun verMapa() {
        ...
        if (latitud.isFinite() && longitud.isFinite()){// si tiene coordenadas validas se muestra
    ...
    private fun deleteLugar() {
        ...
        alerta.setPositiveButton(getString(R.string.msg_si)) { _, _ ->
            ...
            Toast.makeText(
                requireContext(), getString(R.string.msg_lugar_deleted),
    ...
    private fun updateLugar() {
        ...
        if (nombre.isNotEmpty()) { //Al menos tenemos un nombre
            ...
            val lugar = Lugar(
                args.lugar.id, nombre, correo, web, telefono,
                args.lugar.latitud,
                args.lugar.longitud,
                args.lugar.altura,
